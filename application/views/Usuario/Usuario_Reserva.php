        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-10 offset-lg-1">
              ...
              <!-- Page Heading -->
              <h1 class="h2 mb-2  text-center p texto-borde" style="font-size: 70px; color: white">Reservas</h1>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover text-center p" id="reserva" width="100%" cellspacing="0">
