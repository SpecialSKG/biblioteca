...
--
-- Servidor: localhost
-- Tiempo de generación: 14-08-2019 a las 00:51:40
...
CREATE TABLE `autor` (
  ...
  `foto_autor` varchar(300) NOT NULL
...
INSERT INTO `autor` (`id_autor`, `nombre`, `fecha_nacimiento`, `id_pais`, `sexo`, `foto_autor`) VALUES
(3, 'dddddddddd', '2019-08-21', 1, 'sssssss', 'ddddddddd');
...
('12345678-8', 'Cristiano Hermoso Ronaldo', 'CR7', 'hala', 'cr7@gmail.com', '1985-03-14', 45783692, 'Masculino', 'Italia');
...
(1, 'Montañas de Fuego Internacional', 'El Salvador', 'Prol Calle Arce, San Salvador', 22601817),
(2, 'Editorial Jurídica Salvadoreña', 'El Salvador', '1a C Poniente Bis No. 1040, San Salvador', 55555555),
...
(25, 1245, 'Lo que el viento se llevó', 19, 3, '2019-08-01', 1, 's', 300);
...
(24, '45454578-5', 350, '2019-08-21', '2019-08-28', 24),
(25, '45454578-5', 322, '2019-08-19', '2019-08-21', 24),
(26, '45454578-5', 100, '2019-08-27', '2019-08-28', 22),
(27, '45454578-5', 100, '2019-08-13', '2019-08-29', 1),
(28, '45454578-5', 100, '2019-08-27', '2019-08-15', 22),
(29, '45454578-5', 100, '2019-08-27', '2019-08-15', 22);
...
(35, 24, 45454578, 350, '2019-08-21', '2019-08-28'),
(36, 24, 45454578, 322, '2019-08-19', '2019-08-21'),
(37, 22, 45454578, 100, '2019-08-27', '2019-08-28'),
(38, 1, 45454578, 100, '2019-08-13', '2019-08-29'),
(39, 22, 45454578, 100, '2019-08-27', '2019-08-15'),
(40, 22, 45454578, 100, '2019-08-27', '2019-08-15');
...
('12345678-8', 'Cristiano Hermoso Ronaldo', 'CR7', 'hala', 3);
...
--
ALTER TABLE `prestamo_historial`
  MODIFY `id_prestamo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
