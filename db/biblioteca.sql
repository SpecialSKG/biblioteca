...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-08-2019 a las 21:25:59
...
INSERT INTO `categoria` (`id_categoria`, `categoria`, `id_subcategoria`) VALUES
(1, 'terror', 1),
(16, 'infantil', 1),
(17, 'romantico', 1),
(18, 'accion', 1),
...
('01245687-0', 'Jose Alvaro Guerra', 'Alvaro69', '012345', 'jose@gmail.com', '2019-09-14', 75840213, 'Masculino', 'Urbanizacion');
...
DELIMITER $$
CREATE TRIGGER `insertar` BEFORE INSERT ON `reserva` FOR EACH ROW begin 

INSERT into reserva_historial set id_libro = new.id_libro,
dui = new.dui,
...
--
ALTER TABLE `categoria`
  ADD CONSTRAINT `categoria_ibfk_1` FOREIGN KEY (`id_subcategoria`) REFERENCES `subcategoria` (`id_subcategoria`) ON DELETE CASCADE ON UPDATE CASCADE;
